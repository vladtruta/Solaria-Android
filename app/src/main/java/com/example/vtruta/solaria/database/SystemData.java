...
public class SystemData {
    ...
    public void updateTurnLights(int value) {
        databaseReference.child("systems/" + rootName + "/control/turn_lights").setValue(value);
    }

    public void updateDropNutrients(int value) {
        databaseReference.child("systems/" + rootName + "/control/drop_nutriments").setValue(value);
    }

    public void updateUserID(String value) {
        databaseReference.child("systems/" + rootName + "/user").setValue(value);
    }

    public void updateName(String value) {
        databaseReference.child("systems/" + rootName + "/name").setValue(value.trim());
    }

    public void removeUserDatabase() {
        databaseReference.child("systems/" + rootName + "/user").removeValue();
    }
}
